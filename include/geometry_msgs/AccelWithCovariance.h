...
struct AccelWithCovariance_ {
  ...
  AccelWithCovariance_() : accel(), covariance() { covariance.assign(0.0); }
  AccelWithCovariance_(const ContainerAllocator& _alloc) : accel(_alloc), covariance() {
    (void)_alloc;
  ...
  typedef boost::shared_ptr< ::geometry_msgs::AccelWithCovariance_<ContainerAllocator> const>
      ConstPtr;
...
typedef boost::shared_ptr< ::geometry_msgs::AccelWithCovariance const>
...
std::ostream& operator<<(std::ostream& s,
  ...
  ros::message_operations::Printer<
      ::geometry_msgs::AccelWithCovariance_<ContainerAllocator> >::stream(s, "", v);
  return s;
}

template <typename ContainerAllocator1, typename ContainerAllocator2>
bool operator==(const ::geometry_msgs::AccelWithCovariance_<ContainerAllocator1>& lhs,
                const ::geometry_msgs::AccelWithCovariance_<ContainerAllocator2>& rhs) {
...
template <class ContainerAllocator>
struct IsMessage< ::geometry_msgs::AccelWithCovariance_<ContainerAllocator> > : TrueType {};

template <class ContainerAllocator>
struct IsMessage< ::geometry_msgs::AccelWithCovariance_<ContainerAllocator> const> : TrueType {
};

template <class ContainerAllocator>
struct IsFixedSize< ::geometry_msgs::AccelWithCovariance_<ContainerAllocator> > : TrueType {};
...
template <class ContainerAllocator>
struct HasHeader< ::geometry_msgs::AccelWithCovariance_<ContainerAllocator> > : FalseType {};
...
struct MD5Sum< ::geometry_msgs::AccelWithCovariance_<ContainerAllocator> > {
  static const char* value() { return "ad5a718d699c6be72a02b8d6a139f334"; }
