...
struct AccelWithCovarianceStamped_ {
  ...
  AccelWithCovarianceStamped_() : header(), accel() {}
  ...
  typedef boost::shared_ptr< ::geometry_msgs::AccelWithCovarianceStamped_<ContainerAllocator> >
      Ptr;
  typedef boost::shared_ptr<
      ::geometry_msgs::AccelWithCovarianceStamped_<ContainerAllocator> const>
      ConstPtr;

};  // struct AccelWithCovarianceStamped_

typedef ::geometry_msgs::AccelWithCovarianceStamped_<std::allocator<void> >
    AccelWithCovarianceStamped;

typedef boost::shared_ptr< ::geometry_msgs::AccelWithCovarianceStamped>
    AccelWithCovarianceStampedPtr;
typedef boost::shared_ptr< ::geometry_msgs::AccelWithCovarianceStamped const>
...
std::ostream& operator<<(
  ...
  ros::message_operations::Printer<
      ::geometry_msgs::AccelWithCovarianceStamped_<ContainerAllocator> >::stream(s, "", v);
  return s;
}

template <typename ContainerAllocator1, typename ContainerAllocator2>
bool operator==(const ::geometry_msgs::AccelWithCovarianceStamped_<ContainerAllocator1>& lhs,
                const ::geometry_msgs::AccelWithCovarianceStamped_<ContainerAllocator2>& rhs) {
  return lhs.header == rhs.header && lhs.accel == rhs.accel;
}
...
struct MD5Sum< ::geometry_msgs::AccelWithCovarianceStamped_<ContainerAllocator> > {
  static const char* value() { return "96adb295225031ec8d57fb4251b0a886"; }

  static const char* value(
      const ::geometry_msgs::AccelWithCovarianceStamped_<ContainerAllocator>&) {
    return value();
  }
...
struct Definition< ::geometry_msgs::AccelWithCovarianceStamped_<ContainerAllocator> > {
  static const char* value() {
    return "# This represents an estimated accel with reference coordinate frame and "
           "timestamp.\n"
           "Header header\n"
...
struct Printer< ::geometry_msgs::AccelWithCovarianceStamped_<ContainerAllocator> > {
  ...
  static void stream(
    ...
    s << indent << "accel: ";
    s << std::endl;
    Printer< ::geometry_msgs::AccelWithCovariance_<ContainerAllocator> >::stream(
        s, indent + "  ", v.accel);
  }
};
