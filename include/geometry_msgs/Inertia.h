...
struct Inertia_ {
  ...
  Inertia_() : m(0.0), com(), ixx(0.0), ixy(0.0), ixz(0.0), iyy(0.0), iyz(0.0), izz(0.0) {}
...
std::ostream& operator<<(std::ostream& s,
  ...
  ros::message_operations::Printer< ::geometry_msgs::Inertia_<ContainerAllocator> >::stream(
      s, "", v);
  return s;
}

template <typename ContainerAllocator1, typename ContainerAllocator2>
bool operator==(const ::geometry_msgs::Inertia_<ContainerAllocator1>& lhs,
                const ::geometry_msgs::Inertia_<ContainerAllocator2>& rhs) {
  return lhs.m == rhs.m && lhs.com == rhs.com && lhs.ixx == rhs.ixx && lhs.ixy == rhs.ixy &&
         lhs.ixz == rhs.ixz && lhs.iyy == rhs.iyy && lhs.iyz == rhs.iyz && lhs.izz == rhs.izz;
}
...
template <class ContainerAllocator>
struct IsMessage< ::geometry_msgs::Inertia_<ContainerAllocator> > : TrueType {};

template <class ContainerAllocator>
struct IsMessage< ::geometry_msgs::Inertia_<ContainerAllocator> const> : TrueType {};

template <class ContainerAllocator>
struct IsFixedSize< ::geometry_msgs::Inertia_<ContainerAllocator> > : TrueType {};

template <class ContainerAllocator>
struct IsFixedSize< ::geometry_msgs::Inertia_<ContainerAllocator> const> : TrueType {};

template <class ContainerAllocator>
struct HasHeader< ::geometry_msgs::Inertia_<ContainerAllocator> > : FalseType {};

template <class ContainerAllocator>
struct HasHeader< ::geometry_msgs::Inertia_<ContainerAllocator> const> : FalseType {};

template <class ContainerAllocator>
struct MD5Sum< ::geometry_msgs::Inertia_<ContainerAllocator> > {
  static const char* value() { return "1d26e4bb6c83ff141c5cf0d883c2b0fe"; }
