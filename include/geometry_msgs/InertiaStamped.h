...
struct InertiaStamped_ {
  ...
  InertiaStamped_() : header(), inertia() {}
  InertiaStamped_(const ContainerAllocator& _alloc) : header(_alloc), inertia(_alloc) {
    (void)_alloc;
  }
  ...
  typedef boost::shared_ptr< ::geometry_msgs::InertiaStamped_<ContainerAllocator> const>
      ConstPtr;
...
std::ostream& operator<<(std::ostream& s,
  ...
  ros::message_operations::Printer<
      ::geometry_msgs::InertiaStamped_<ContainerAllocator> >::stream(s, "", v);
  return s;
}

template <typename ContainerAllocator1, typename ContainerAllocator2>
bool operator==(const ::geometry_msgs::InertiaStamped_<ContainerAllocator1>& lhs,
                const ::geometry_msgs::InertiaStamped_<ContainerAllocator2>& rhs) {
  return lhs.header == rhs.header && lhs.inertia == rhs.inertia;
}
...
template <class ContainerAllocator>
struct IsMessage< ::geometry_msgs::InertiaStamped_<ContainerAllocator> > : TrueType {};

template <class ContainerAllocator>
struct IsMessage< ::geometry_msgs::InertiaStamped_<ContainerAllocator> const> : TrueType {};

template <class ContainerAllocator>
struct IsFixedSize< ::geometry_msgs::InertiaStamped_<ContainerAllocator> > : FalseType {};

template <class ContainerAllocator>
struct IsFixedSize< ::geometry_msgs::InertiaStamped_<ContainerAllocator> const> : FalseType {};

template <class ContainerAllocator>
struct HasHeader< ::geometry_msgs::InertiaStamped_<ContainerAllocator> > : TrueType {};

template <class ContainerAllocator>
struct HasHeader< ::geometry_msgs::InertiaStamped_<ContainerAllocator> const> : TrueType {};

template <class ContainerAllocator>
struct MD5Sum< ::geometry_msgs::InertiaStamped_<ContainerAllocator> > {
  static const char* value() { return "ddee48caeab5a966c5e8d166654a9ac7"; }
...
struct Printer< ::geometry_msgs::InertiaStamped_<ContainerAllocator> > {
  ...
  static void stream(Stream& s, const std::string& indent,
    ...
    s << indent << "inertia: ";
    s << std::endl;
    Printer< ::geometry_msgs::Inertia_<ContainerAllocator> >::stream(s, indent + "  ",
                                                                     v.inertia);
  }
};
