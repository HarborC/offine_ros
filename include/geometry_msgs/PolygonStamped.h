...
struct PolygonStamped_ {
  ...
  PolygonStamped_(const ContainerAllocator& _alloc) : header(_alloc), polygon(_alloc) {
    (void)_alloc;
  }
  ...
  typedef boost::shared_ptr< ::geometry_msgs::PolygonStamped_<ContainerAllocator> const>
      ConstPtr;
...
std::ostream& operator<<(std::ostream& s,
  ...
  ros::message_operations::Printer<
      ::geometry_msgs::PolygonStamped_<ContainerAllocator> >::stream(s, "", v);
  return s;
}

template <typename ContainerAllocator1, typename ContainerAllocator2>
bool operator==(const ::geometry_msgs::PolygonStamped_<ContainerAllocator1>& lhs,
                const ::geometry_msgs::PolygonStamped_<ContainerAllocator2>& rhs) {
  return lhs.header == rhs.header && lhs.polygon == rhs.polygon;
}
...
template <class ContainerAllocator>
struct IsMessage< ::geometry_msgs::PolygonStamped_<ContainerAllocator> > : TrueType {};

template <class ContainerAllocator>
struct IsMessage< ::geometry_msgs::PolygonStamped_<ContainerAllocator> const> : TrueType {};

template <class ContainerAllocator>
struct IsFixedSize< ::geometry_msgs::PolygonStamped_<ContainerAllocator> > : FalseType {};

template <class ContainerAllocator>
struct IsFixedSize< ::geometry_msgs::PolygonStamped_<ContainerAllocator> const> : FalseType {};

template <class ContainerAllocator>
struct HasHeader< ::geometry_msgs::PolygonStamped_<ContainerAllocator> > : TrueType {};

template <class ContainerAllocator>
struct HasHeader< ::geometry_msgs::PolygonStamped_<ContainerAllocator> const> : TrueType {};

template <class ContainerAllocator>
struct MD5Sum< ::geometry_msgs::PolygonStamped_<ContainerAllocator> > {
  static const char* value() { return "c6be8f7dc3bee7fe9e8d296070f53340"; }
...
struct Definition< ::geometry_msgs::PolygonStamped_<ContainerAllocator> > {
  static const char* value() {
    return "# This represents a Polygon with reference coordinate frame and timestamp\n"
           ...
           "#A specification of a polygon where the first and last points are assumed to be "
           "connected\n"
           "Point32[] points\n"
           "\n"
           "================================================================================\n"
...
struct Printer< ::geometry_msgs::PolygonStamped_<ContainerAllocator> > {
  ...
  static void stream(Stream& s, const std::string& indent,
    ...
    s << indent << "polygon: ";
    s << std::endl;
    Printer< ::geometry_msgs::Polygon_<ContainerAllocator> >::stream(s, indent + "  ",
                                                                     v.polygon);
  }
};
