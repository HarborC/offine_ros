...
struct QuaternionStamped_ {
  ...
  QuaternionStamped_(const ContainerAllocator& _alloc) : header(_alloc), quaternion(_alloc) {
    (void)_alloc;
  }
  ...
  typedef boost::shared_ptr< ::geometry_msgs::QuaternionStamped_<ContainerAllocator> const>
      ConstPtr;
...
std::ostream& operator<<(std::ostream& s,
  ...
  ros::message_operations::Printer<
      ::geometry_msgs::QuaternionStamped_<ContainerAllocator> >::stream(s, "", v);
  return s;
}

template <typename ContainerAllocator1, typename ContainerAllocator2>
bool operator==(const ::geometry_msgs::QuaternionStamped_<ContainerAllocator1>& lhs,
                const ::geometry_msgs::QuaternionStamped_<ContainerAllocator2>& rhs) {
  return lhs.header == rhs.header && lhs.quaternion == rhs.quaternion;
}
...
template <class ContainerAllocator>
struct IsMessage< ::geometry_msgs::QuaternionStamped_<ContainerAllocator> > : TrueType {};

template <class ContainerAllocator>
struct IsMessage< ::geometry_msgs::QuaternionStamped_<ContainerAllocator> const> : TrueType {};

template <class ContainerAllocator>
struct IsFixedSize< ::geometry_msgs::QuaternionStamped_<ContainerAllocator> > : FalseType {};
...
template <class ContainerAllocator>
struct HasHeader< ::geometry_msgs::QuaternionStamped_<ContainerAllocator> > : TrueType {};

template <class ContainerAllocator>
struct HasHeader< ::geometry_msgs::QuaternionStamped_<ContainerAllocator> const> : TrueType {};

template <class ContainerAllocator>
struct MD5Sum< ::geometry_msgs::QuaternionStamped_<ContainerAllocator> > {
  static const char* value() { return "e57f1e547e0e1fd13504588ffc8334e2"; }
...
struct Printer< ::geometry_msgs::QuaternionStamped_<ContainerAllocator> > {
  ...
  static void stream(Stream& s, const std::string& indent,
    ...
    s << indent << "quaternion: ";
    s << std::endl;
    Printer< ::geometry_msgs::Quaternion_<ContainerAllocator> >::stream(s, indent + "  ",
                                                                        v.quaternion);
  }
};
