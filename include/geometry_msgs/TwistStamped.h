...
struct TwistStamped_ {
  ...
  TwistStamped_(const ContainerAllocator& _alloc) : header(_alloc), twist(_alloc) {
    (void)_alloc;
  }
  ...
  typedef boost::shared_ptr< ::geometry_msgs::TwistStamped_<ContainerAllocator> const>
      ConstPtr;
...
std::ostream& operator<<(std::ostream& s,
  ...
  ros::message_operations::Printer<
      ::geometry_msgs::TwistStamped_<ContainerAllocator> >::stream(s, "", v);
  return s;
}

template <typename ContainerAllocator1, typename ContainerAllocator2>
bool operator==(const ::geometry_msgs::TwistStamped_<ContainerAllocator1>& lhs,
                const ::geometry_msgs::TwistStamped_<ContainerAllocator2>& rhs) {
...
template <class ContainerAllocator>
struct IsMessage< ::geometry_msgs::TwistStamped_<ContainerAllocator> > : TrueType {};

template <class ContainerAllocator>
struct IsMessage< ::geometry_msgs::TwistStamped_<ContainerAllocator> const> : TrueType {};

template <class ContainerAllocator>
struct IsFixedSize< ::geometry_msgs::TwistStamped_<ContainerAllocator> > : FalseType {};

template <class ContainerAllocator>
struct IsFixedSize< ::geometry_msgs::TwistStamped_<ContainerAllocator> const> : FalseType {};

template <class ContainerAllocator>
struct HasHeader< ::geometry_msgs::TwistStamped_<ContainerAllocator> > : TrueType {};

template <class ContainerAllocator>
struct HasHeader< ::geometry_msgs::TwistStamped_<ContainerAllocator> const> : TrueType {};

template <class ContainerAllocator>
struct MD5Sum< ::geometry_msgs::TwistStamped_<ContainerAllocator> > {
  static const char* value() { return "98d34b0043a2093cf9d9345ab6eef12e"; }

  static const char* value(const ::geometry_msgs::TwistStamped_<ContainerAllocator>&) {
    return value();
  }
