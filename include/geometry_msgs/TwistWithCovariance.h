...
struct TwistWithCovariance_ {
  ...
  TwistWithCovariance_() : twist(), covariance() { covariance.assign(0.0); }
  TwistWithCovariance_(const ContainerAllocator& _alloc) : twist(_alloc), covariance() {
    (void)_alloc;
  ...
  typedef boost::shared_ptr< ::geometry_msgs::TwistWithCovariance_<ContainerAllocator> const>
      ConstPtr;
...
typedef boost::shared_ptr< ::geometry_msgs::TwistWithCovariance const>
...
std::ostream& operator<<(std::ostream& s,
  ...
  ros::message_operations::Printer<
      ::geometry_msgs::TwistWithCovariance_<ContainerAllocator> >::stream(s, "", v);
  return s;
}

template <typename ContainerAllocator1, typename ContainerAllocator2>
bool operator==(const ::geometry_msgs::TwistWithCovariance_<ContainerAllocator1>& lhs,
                const ::geometry_msgs::TwistWithCovariance_<ContainerAllocator2>& rhs) {
...
template <class ContainerAllocator>
struct IsMessage< ::geometry_msgs::TwistWithCovariance_<ContainerAllocator> > : TrueType {};

template <class ContainerAllocator>
struct IsMessage< ::geometry_msgs::TwistWithCovariance_<ContainerAllocator> const> : TrueType {
};

template <class ContainerAllocator>
struct IsFixedSize< ::geometry_msgs::TwistWithCovariance_<ContainerAllocator> > : TrueType {};
...
template <class ContainerAllocator>
struct HasHeader< ::geometry_msgs::TwistWithCovariance_<ContainerAllocator> > : FalseType {};
...
struct MD5Sum< ::geometry_msgs::TwistWithCovariance_<ContainerAllocator> > {
  static const char* value() { return "1fe8a28e6890a4cc3ae4c3ca5c7d82e6"; }
