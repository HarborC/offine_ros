...
struct Vector3Stamped_ {
  ...
  Vector3Stamped_(const ContainerAllocator& _alloc) : header(_alloc), vector(_alloc) {
    (void)_alloc;
  }
  ...
  typedef boost::shared_ptr< ::geometry_msgs::Vector3Stamped_<ContainerAllocator> const>
      ConstPtr;
...
std::ostream& operator<<(std::ostream& s,
  ...
  ros::message_operations::Printer<
      ::geometry_msgs::Vector3Stamped_<ContainerAllocator> >::stream(s, "", v);
  return s;
}

template <typename ContainerAllocator1, typename ContainerAllocator2>
bool operator==(const ::geometry_msgs::Vector3Stamped_<ContainerAllocator1>& lhs,
                const ::geometry_msgs::Vector3Stamped_<ContainerAllocator2>& rhs) {
  return lhs.header == rhs.header && lhs.vector == rhs.vector;
}
...
template <class ContainerAllocator>
struct IsMessage< ::geometry_msgs::Vector3Stamped_<ContainerAllocator> > : TrueType {};

template <class ContainerAllocator>
struct IsMessage< ::geometry_msgs::Vector3Stamped_<ContainerAllocator> const> : TrueType {};

template <class ContainerAllocator>
struct IsFixedSize< ::geometry_msgs::Vector3Stamped_<ContainerAllocator> > : FalseType {};

template <class ContainerAllocator>
struct IsFixedSize< ::geometry_msgs::Vector3Stamped_<ContainerAllocator> const> : FalseType {};

template <class ContainerAllocator>
struct HasHeader< ::geometry_msgs::Vector3Stamped_<ContainerAllocator> > : TrueType {};

template <class ContainerAllocator>
struct HasHeader< ::geometry_msgs::Vector3Stamped_<ContainerAllocator> const> : TrueType {};

template <class ContainerAllocator>
struct MD5Sum< ::geometry_msgs::Vector3Stamped_<ContainerAllocator> > {
  static const char* value() { return "7b324c7325e683bf02a9b14b01090ec7"; }
...
struct Printer< ::geometry_msgs::Vector3Stamped_<ContainerAllocator> > {
  ...
  static void stream(Stream& s, const std::string& indent,
    ...
    s << indent << "vector: ";
    s << std::endl;
    Printer< ::geometry_msgs::Vector3_<ContainerAllocator> >::stream(s, indent + "  ",
                                                                     v.vector);
  }
};
