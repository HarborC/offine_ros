...
struct WrenchStamped_ {
  ...
  WrenchStamped_() : header(), wrench() {}
  WrenchStamped_(const ContainerAllocator& _alloc) : header(_alloc), wrench(_alloc) {
    (void)_alloc;
  }
  ...
  typedef boost::shared_ptr< ::geometry_msgs::WrenchStamped_<ContainerAllocator> const>
      ConstPtr;
...
std::ostream& operator<<(std::ostream& s,
  ...
  ros::message_operations::Printer<
      ::geometry_msgs::WrenchStamped_<ContainerAllocator> >::stream(s, "", v);
  return s;
}

template <typename ContainerAllocator1, typename ContainerAllocator2>
bool operator==(const ::geometry_msgs::WrenchStamped_<ContainerAllocator1>& lhs,
                const ::geometry_msgs::WrenchStamped_<ContainerAllocator2>& rhs) {
  return lhs.header == rhs.header && lhs.wrench == rhs.wrench;
}
...
template <class ContainerAllocator>
struct IsMessage< ::geometry_msgs::WrenchStamped_<ContainerAllocator> > : TrueType {};

template <class ContainerAllocator>
struct IsMessage< ::geometry_msgs::WrenchStamped_<ContainerAllocator> const> : TrueType {};

template <class ContainerAllocator>
struct IsFixedSize< ::geometry_msgs::WrenchStamped_<ContainerAllocator> > : FalseType {};

template <class ContainerAllocator>
struct IsFixedSize< ::geometry_msgs::WrenchStamped_<ContainerAllocator> const> : FalseType {};

template <class ContainerAllocator>
struct HasHeader< ::geometry_msgs::WrenchStamped_<ContainerAllocator> > : TrueType {};

template <class ContainerAllocator>
struct HasHeader< ::geometry_msgs::WrenchStamped_<ContainerAllocator> const> : TrueType {};

template <class ContainerAllocator>
struct MD5Sum< ::geometry_msgs::WrenchStamped_<ContainerAllocator> > {
  static const char* value() { return "d78d3cb249ce23087ade7e7d0c40cfa7"; }

  static const char* value(const ::geometry_msgs::WrenchStamped_<ContainerAllocator>&) {
    return value();
  }
