...
struct CustomMsg_ {
  ...
  CustomMsg_() : header(), timebase(0), point_num(0), lidar_id(0), rsvd(), points() {
    rsvd.assign(0);
  }
  ...
  typedef std::vector< ::livox_ros_driver::CustomPoint_<ContainerAllocator>,
  ...
  typedef boost::shared_ptr< ::livox_ros_driver::CustomMsg_<ContainerAllocator> const>
      ConstPtr;
...
bool operator==(const ::livox_ros_driver::CustomMsg_<ContainerAllocator1>& lhs,
                const ::livox_ros_driver::CustomMsg_<ContainerAllocator2>& rhs) {
...
struct MD5Sum< ::livox_ros_driver::CustomMsg_<ContainerAllocator> > {
  ...
  static const char* value(const ::livox_ros_driver::CustomMsg_<ContainerAllocator>&) {
    return value();
  }
