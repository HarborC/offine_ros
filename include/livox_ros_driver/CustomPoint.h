...
struct CustomPoint_ {
  ...
  CustomPoint_() : offset_time(0), x(0.0), y(0.0), z(0.0), reflectivity(0), tag(0), line(0) {}
  CustomPoint_(const ContainerAllocator& _alloc)
      : offset_time(0), x(0.0), y(0.0), z(0.0), reflectivity(0), tag(0), line(0) {
    (void)_alloc;
  }
  ...
  typedef boost::shared_ptr< ::livox_ros_driver::CustomPoint_<ContainerAllocator> const>
      ConstPtr;
...
std::ostream& operator<<(std::ostream& s,
                         const ::livox_ros_driver::CustomPoint_<ContainerAllocator>& v) {
  ros::message_operations::Printer<
      ::livox_ros_driver::CustomPoint_<ContainerAllocator> >::stream(s, "", v);
  return s;
}

template <typename ContainerAllocator1, typename ContainerAllocator2>
bool operator==(const ::livox_ros_driver::CustomPoint_<ContainerAllocator1>& lhs,
                const ::livox_ros_driver::CustomPoint_<ContainerAllocator2>& rhs) {
  return lhs.offset_time == rhs.offset_time && lhs.x == rhs.x && lhs.y == rhs.y &&
         lhs.z == rhs.z && lhs.reflectivity == rhs.reflectivity && lhs.tag == rhs.tag &&
         lhs.line == rhs.line;
}
...
template <class ContainerAllocator>
struct IsFixedSize< ::livox_ros_driver::CustomPoint_<ContainerAllocator> > : TrueType {};

template <class ContainerAllocator>
struct IsFixedSize< ::livox_ros_driver::CustomPoint_<ContainerAllocator> const> : TrueType {};

template <class ContainerAllocator>
struct IsMessage< ::livox_ros_driver::CustomPoint_<ContainerAllocator> > : TrueType {};

template <class ContainerAllocator>
struct IsMessage< ::livox_ros_driver::CustomPoint_<ContainerAllocator> const> : TrueType {};

template <class ContainerAllocator>
struct HasHeader< ::livox_ros_driver::CustomPoint_<ContainerAllocator> > : FalseType {};

template <class ContainerAllocator>
struct HasHeader< ::livox_ros_driver::CustomPoint_<ContainerAllocator> const> : FalseType {};
...
struct MD5Sum< ::livox_ros_driver::CustomPoint_<ContainerAllocator> > {
  ...
  static const char* value(const ::livox_ros_driver::CustomPoint_<ContainerAllocator>&) {
    return value();
  }
...
template <class ContainerAllocator>
struct Serializer< ::livox_ros_driver::CustomPoint_<ContainerAllocator> > {
