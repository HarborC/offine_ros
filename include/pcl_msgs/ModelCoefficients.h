...
struct ModelCoefficients_ {
  ...
  ModelCoefficients_() : header(), values() {}
  ModelCoefficients_(const ContainerAllocator& _alloc) : header(_alloc), values(_alloc) {
    (void)_alloc;
  }
  ...
  typedef std::vector<float, typename ContainerAllocator::template rebind<float>::other>
      _values_type;
  _values_type values;

  typedef boost::shared_ptr< ::pcl_msgs::ModelCoefficients_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::pcl_msgs::ModelCoefficients_<ContainerAllocator> const>
      ConstPtr;
...
std::ostream& operator<<(std::ostream& s,
  ...
  ros::message_operations::Printer<
      ::pcl_msgs::ModelCoefficients_<ContainerAllocator> >::stream(s, "", v);
  return s;
}

template <typename ContainerAllocator1, typename ContainerAllocator2>
bool operator==(const ::pcl_msgs::ModelCoefficients_<ContainerAllocator1>& lhs,
                const ::pcl_msgs::ModelCoefficients_<ContainerAllocator2>& rhs) {
  return lhs.header == rhs.header && lhs.values == rhs.values;
}
...
template <class ContainerAllocator>
struct IsFixedSize< ::pcl_msgs::ModelCoefficients_<ContainerAllocator> > : FalseType {};

template <class ContainerAllocator>
struct IsFixedSize< ::pcl_msgs::ModelCoefficients_<ContainerAllocator> const> : FalseType {};

template <class ContainerAllocator>
struct IsMessage< ::pcl_msgs::ModelCoefficients_<ContainerAllocator> > : TrueType {};

template <class ContainerAllocator>
struct IsMessage< ::pcl_msgs::ModelCoefficients_<ContainerAllocator> const> : TrueType {};

template <class ContainerAllocator>
struct HasHeader< ::pcl_msgs::ModelCoefficients_<ContainerAllocator> > : TrueType {};

template <class ContainerAllocator>
struct HasHeader< ::pcl_msgs::ModelCoefficients_<ContainerAllocator> const> : TrueType {};

template <class ContainerAllocator>
struct MD5Sum< ::pcl_msgs::ModelCoefficients_<ContainerAllocator> > {
  static const char* value() { return "ca27dea75e72cb894cd36f9e5005e93e"; }
