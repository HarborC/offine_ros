...
struct PointIndices_ {
  ...
  PointIndices_() : header(), indices() {}
  PointIndices_(const ContainerAllocator& _alloc) : header(_alloc), indices(_alloc) {
    (void)_alloc;
  }
  ...
  typedef std::vector<int32_t, typename ContainerAllocator::template rebind<int32_t>::other>
      _indices_type;
...
std::ostream& operator<<(std::ostream& s,
  ...
  ros::message_operations::Printer< ::pcl_msgs::PointIndices_<ContainerAllocator> >::stream(
      s, "", v);
  return s;
}

template <typename ContainerAllocator1, typename ContainerAllocator2>
bool operator==(const ::pcl_msgs::PointIndices_<ContainerAllocator1>& lhs,
                const ::pcl_msgs::PointIndices_<ContainerAllocator2>& rhs) {
  return lhs.header == rhs.header && lhs.indices == rhs.indices;
}
...
template <class ContainerAllocator>
struct IsFixedSize< ::pcl_msgs::PointIndices_<ContainerAllocator> > : FalseType {};

template <class ContainerAllocator>
struct IsFixedSize< ::pcl_msgs::PointIndices_<ContainerAllocator> const> : FalseType {};

template <class ContainerAllocator>
struct IsMessage< ::pcl_msgs::PointIndices_<ContainerAllocator> > : TrueType {};

template <class ContainerAllocator>
struct IsMessage< ::pcl_msgs::PointIndices_<ContainerAllocator> const> : TrueType {};

template <class ContainerAllocator>
struct HasHeader< ::pcl_msgs::PointIndices_<ContainerAllocator> > : TrueType {};

template <class ContainerAllocator>
struct HasHeader< ::pcl_msgs::PointIndices_<ContainerAllocator> const> : TrueType {};

template <class ContainerAllocator>
struct MD5Sum< ::pcl_msgs::PointIndices_<ContainerAllocator> > {
  static const char* value() { return "458c7998b7eaf99908256472e273b3d4"; }
