...
struct PolygonMesh_ {
  ...
  PolygonMesh_() : header(), cloud(), polygons() {}
  PolygonMesh_(const ContainerAllocator& _alloc)
      : header(_alloc), cloud(_alloc), polygons(_alloc) {
    (void)_alloc;
  }
  ...
  typedef std::vector< ::pcl_msgs::Vertices_<ContainerAllocator>,
                       typename ContainerAllocator::template rebind<
                           ::pcl_msgs::Vertices_<ContainerAllocator> >::other>
      _polygons_type;
...
std::ostream& operator<<(std::ostream& s,
  ...
  ros::message_operations::Printer< ::pcl_msgs::PolygonMesh_<ContainerAllocator> >::stream(
      s, "", v);
  return s;
}

template <typename ContainerAllocator1, typename ContainerAllocator2>
bool operator==(const ::pcl_msgs::PolygonMesh_<ContainerAllocator1>& lhs,
                const ::pcl_msgs::PolygonMesh_<ContainerAllocator2>& rhs) {
  return lhs.header == rhs.header && lhs.cloud == rhs.cloud && lhs.polygons == rhs.polygons;
}
...
template <class ContainerAllocator>
struct IsFixedSize< ::pcl_msgs::PolygonMesh_<ContainerAllocator> > : FalseType {};

template <class ContainerAllocator>
struct IsFixedSize< ::pcl_msgs::PolygonMesh_<ContainerAllocator> const> : FalseType {};

template <class ContainerAllocator>
struct IsMessage< ::pcl_msgs::PolygonMesh_<ContainerAllocator> > : TrueType {};

template <class ContainerAllocator>
struct IsMessage< ::pcl_msgs::PolygonMesh_<ContainerAllocator> const> : TrueType {};

template <class ContainerAllocator>
struct HasHeader< ::pcl_msgs::PolygonMesh_<ContainerAllocator> > : TrueType {};

template <class ContainerAllocator>
struct HasHeader< ::pcl_msgs::PolygonMesh_<ContainerAllocator> const> : TrueType {};

template <class ContainerAllocator>
struct MD5Sum< ::pcl_msgs::PolygonMesh_<ContainerAllocator> > {
  static const char* value() { return "45a5fc6ad2cde8489600a790acc9a38a"; }
...
struct Printer< ::pcl_msgs::PolygonMesh_<ContainerAllocator> > {
  ...
  static void stream(Stream& s, const std::string& indent,
    ...
    s << indent << "cloud: ";
    s << std::endl;
    Printer< ::sensor_msgs::PointCloud2_<ContainerAllocator> >::stream(s, indent + "  ",
                                                                       v.cloud);
    ...
    for (size_t i = 0; i < v.polygons.size(); ++i) {
      ...
      s << std::endl;
      s << indent;
      Printer< ::pcl_msgs::Vertices_<ContainerAllocator> >::stream(s, indent + "    ",
                                                                   v.polygons[i]);
    }
  }
};
