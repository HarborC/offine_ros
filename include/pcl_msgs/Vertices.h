...
struct Vertices_ {
  ...
  Vertices_() : vertices() {}
  Vertices_(const ContainerAllocator& _alloc) : vertices(_alloc) { (void)_alloc; }

  typedef std::vector<uint32_t, typename ContainerAllocator::template rebind<uint32_t>::other>
      _vertices_type;
...
std::ostream& operator<<(std::ostream& s, const ::pcl_msgs::Vertices_<ContainerAllocator>& v) {
  ros::message_operations::Printer< ::pcl_msgs::Vertices_<ContainerAllocator> >::stream(s, "",
                                                                                        v);
  return s;
}

template <typename ContainerAllocator1, typename ContainerAllocator2>
bool operator==(const ::pcl_msgs::Vertices_<ContainerAllocator1>& lhs,
...
template <class ContainerAllocator>
struct IsFixedSize< ::pcl_msgs::Vertices_<ContainerAllocator> > : FalseType {};

template <class ContainerAllocator>
struct IsFixedSize< ::pcl_msgs::Vertices_<ContainerAllocator> const> : FalseType {};

template <class ContainerAllocator>
struct IsMessage< ::pcl_msgs::Vertices_<ContainerAllocator> > : TrueType {};

template <class ContainerAllocator>
struct IsMessage< ::pcl_msgs::Vertices_<ContainerAllocator> const> : TrueType {};

template <class ContainerAllocator>
struct HasHeader< ::pcl_msgs::Vertices_<ContainerAllocator> > : FalseType {};

template <class ContainerAllocator>
struct HasHeader< ::pcl_msgs::Vertices_<ContainerAllocator> const> : FalseType {};

template <class ContainerAllocator>
struct MD5Sum< ::pcl_msgs::Vertices_<ContainerAllocator> > {
  static const char* value() { return "39bd7b1c23763ddd1b882b97cb7cfe11"; }
