...
std::ostream& operator<<(std::ostream& s,
  ...
  ros::message_operations::Printer<::sensor_msgs::BatteryState_<ContainerAllocator>>::stream(
      s, "", v);
  return s;
}

template <typename ContainerAllocator1, typename ContainerAllocator2>
bool operator==(const ::sensor_msgs::BatteryState_<ContainerAllocator1>& lhs,
                const ::sensor_msgs::BatteryState_<ContainerAllocator2>& rhs) {
  return lhs.header == rhs.header && lhs.voltage == rhs.voltage &&
         lhs.temperature == rhs.temperature && lhs.current == rhs.current &&
         lhs.charge == rhs.charge && lhs.capacity == rhs.capacity &&
         lhs.design_capacity == rhs.design_capacity && lhs.percentage == rhs.percentage &&
         ...
         lhs.present == rhs.present && lhs.cell_voltage == rhs.cell_voltage &&
         lhs.cell_temperature == rhs.cell_temperature && lhs.location == rhs.location &&
...
template <class ContainerAllocator>
struct IsMessage<::sensor_msgs::BatteryState_<ContainerAllocator>> : TrueType {};

template <class ContainerAllocator>
struct IsMessage<::sensor_msgs::BatteryState_<ContainerAllocator> const> : TrueType {};

template <class ContainerAllocator>
struct IsFixedSize<::sensor_msgs::BatteryState_<ContainerAllocator>> : FalseType {};

template <class ContainerAllocator>
struct IsFixedSize<::sensor_msgs::BatteryState_<ContainerAllocator> const> : FalseType {};

template <class ContainerAllocator>
struct HasHeader<::sensor_msgs::BatteryState_<ContainerAllocator>> : TrueType {};

template <class ContainerAllocator>
struct HasHeader<::sensor_msgs::BatteryState_<ContainerAllocator> const> : TrueType {};

template <class ContainerAllocator>
struct MD5Sum<::sensor_msgs::BatteryState_<ContainerAllocator>> {
  static const char* value() { return "4ddae7f048e32fda22cac764685e3974"; }
...
struct Definition<::sensor_msgs::BatteryState_<ContainerAllocator>> {
  static const char* value() {
    return "\n"
           ...
           "float32 capacity         # Capacity in Ah (last full capacity)  (If unmeasured "
           "NaN)\n"
           ...
           "\n"
           "float32[] cell_voltage   # An array of individual cell voltages for each cell in "
           "the pack\n"
           "                         # If individual voltages unknown but number of cells "
           "known set each to NaN\n"
           "float32[] cell_temperature  # An array of individual cell temperatures for each "
           "cell in the pack\n"
           "                            # If individual temperatures unknown but number of "
           "cells known set each to NaN\n"
           "string location          # The location into which the battery is inserted. (slot "
           "number or plug)\n"
