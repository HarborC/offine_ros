...
struct FluidPressure_ {
  ...
  FluidPressure_() : header(), fluid_pressure(0.0), variance(0.0) {}
  FluidPressure_(const ContainerAllocator& _alloc)
      : header(_alloc), fluid_pressure(0.0), variance(0.0) {
    (void)_alloc;
  }
...
std::ostream& operator<<(std::ostream& s,
  ...
  ros::message_operations::Printer<
      ::sensor_msgs::FluidPressure_<ContainerAllocator> >::stream(s, "", v);
  return s;
}

template <typename ContainerAllocator1, typename ContainerAllocator2>
bool operator==(const ::sensor_msgs::FluidPressure_<ContainerAllocator1>& lhs,
                const ::sensor_msgs::FluidPressure_<ContainerAllocator2>& rhs) {
  return lhs.header == rhs.header && lhs.fluid_pressure == rhs.fluid_pressure &&
...
template <class ContainerAllocator>
struct IsMessage< ::sensor_msgs::FluidPressure_<ContainerAllocator> > : TrueType {};

template <class ContainerAllocator>
struct IsMessage< ::sensor_msgs::FluidPressure_<ContainerAllocator> const> : TrueType {};

template <class ContainerAllocator>
struct IsFixedSize< ::sensor_msgs::FluidPressure_<ContainerAllocator> > : FalseType {};

template <class ContainerAllocator>
struct IsFixedSize< ::sensor_msgs::FluidPressure_<ContainerAllocator> const> : FalseType {};

template <class ContainerAllocator>
struct HasHeader< ::sensor_msgs::FluidPressure_<ContainerAllocator> > : TrueType {};

template <class ContainerAllocator>
struct HasHeader< ::sensor_msgs::FluidPressure_<ContainerAllocator> const> : TrueType {};

template <class ContainerAllocator>
struct MD5Sum< ::sensor_msgs::FluidPressure_<ContainerAllocator> > {
  static const char* value() { return "804dc5cea1c5306d6a2eb80b9833befe"; }
