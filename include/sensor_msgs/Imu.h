...
std::ostream& operator<<(std::ostream& s, const ::sensor_msgs::Imu_<ContainerAllocator>& v) {
  ros::message_operations::Printer< ::sensor_msgs::Imu_<ContainerAllocator> >::stream(s, "",
                                                                                      v);
  return s;
}

template <typename ContainerAllocator1, typename ContainerAllocator2>
bool operator==(const ::sensor_msgs::Imu_<ContainerAllocator1>& lhs,
                const ::sensor_msgs::Imu_<ContainerAllocator2>& rhs) {
  return lhs.header == rhs.header && lhs.orientation == rhs.orientation &&
...
template <class ContainerAllocator>
struct IsMessage< ::sensor_msgs::Imu_<ContainerAllocator> > : TrueType {};

template <class ContainerAllocator>
struct IsMessage< ::sensor_msgs::Imu_<ContainerAllocator> const> : TrueType {};

template <class ContainerAllocator>
struct IsFixedSize< ::sensor_msgs::Imu_<ContainerAllocator> > : FalseType {};

template <class ContainerAllocator>
struct IsFixedSize< ::sensor_msgs::Imu_<ContainerAllocator> const> : FalseType {};

template <class ContainerAllocator>
struct HasHeader< ::sensor_msgs::Imu_<ContainerAllocator> > : TrueType {};

template <class ContainerAllocator>
struct HasHeader< ::sensor_msgs::Imu_<ContainerAllocator> const> : TrueType {};

template <class ContainerAllocator>
struct MD5Sum< ::sensor_msgs::Imu_<ContainerAllocator> > {
  static const char* value() { return "6a62c6daae103f4ff57a132d6f95cec2"; }
