...
struct Joy_ {
  ...
  Joy_() : header(), axes(), buttons() {}
  Joy_(const ContainerAllocator& _alloc) : header(_alloc), axes(_alloc), buttons(_alloc) {
    (void)_alloc;
  }
...
bool operator==(const ::sensor_msgs::Joy_<ContainerAllocator1>& lhs,
                const ::sensor_msgs::Joy_<ContainerAllocator2>& rhs) {
  return lhs.header == rhs.header && lhs.axes == rhs.axes && lhs.buttons == rhs.buttons;
}
...
template <class ContainerAllocator>
struct IsMessage<::sensor_msgs::Joy_<ContainerAllocator>> : TrueType {};

template <class ContainerAllocator>
struct IsMessage<::sensor_msgs::Joy_<ContainerAllocator> const> : TrueType {};

template <class ContainerAllocator>
struct IsFixedSize<::sensor_msgs::Joy_<ContainerAllocator>> : FalseType {};

template <class ContainerAllocator>
struct IsFixedSize<::sensor_msgs::Joy_<ContainerAllocator> const> : FalseType {};

template <class ContainerAllocator>
struct HasHeader<::sensor_msgs::Joy_<ContainerAllocator>> : TrueType {};

template <class ContainerAllocator>
struct HasHeader<::sensor_msgs::Joy_<ContainerAllocator> const> : TrueType {};

template <class ContainerAllocator>
struct MD5Sum<::sensor_msgs::Joy_<ContainerAllocator>> {
  static const char* value() { return "5a9ea5f83505693b71e785041e67a8bb"; }
...
struct Definition<::sensor_msgs::Joy_<ContainerAllocator>> {
  static const char* value() {
    return "# Reports the state of a joysticks axes and buttons.\n"
           "Header header           # timestamp in the header is the time the data is "
           "received from the joystick\n"
