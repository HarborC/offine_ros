...
struct MagneticField_ {
  ...
  MagneticField_() : header(), magnetic_field(), magnetic_field_covariance() {
    magnetic_field_covariance.assign(0.0);
  }
  MagneticField_(const ContainerAllocator& _alloc)
      : header(_alloc), magnetic_field(_alloc), magnetic_field_covariance() {
    (void)_alloc;
    magnetic_field_covariance.assign(0.0);
  }
...
std::ostream& operator<<(std::ostream& s,
  ...
  ros::message_operations::Printer<
      ::sensor_msgs::MagneticField_<ContainerAllocator> >::stream(s, "", v);
  return s;
}

template <typename ContainerAllocator1, typename ContainerAllocator2>
bool operator==(const ::sensor_msgs::MagneticField_<ContainerAllocator1>& lhs,
                const ::sensor_msgs::MagneticField_<ContainerAllocator2>& rhs) {
  return lhs.header == rhs.header && lhs.magnetic_field == rhs.magnetic_field &&
...
template <class ContainerAllocator>
struct IsMessage< ::sensor_msgs::MagneticField_<ContainerAllocator> > : TrueType {};

template <class ContainerAllocator>
struct IsMessage< ::sensor_msgs::MagneticField_<ContainerAllocator> const> : TrueType {};

template <class ContainerAllocator>
struct IsFixedSize< ::sensor_msgs::MagneticField_<ContainerAllocator> > : FalseType {};

template <class ContainerAllocator>
struct IsFixedSize< ::sensor_msgs::MagneticField_<ContainerAllocator> const> : FalseType {};

template <class ContainerAllocator>
struct HasHeader< ::sensor_msgs::MagneticField_<ContainerAllocator> > : TrueType {};

template <class ContainerAllocator>
struct HasHeader< ::sensor_msgs::MagneticField_<ContainerAllocator> const> : TrueType {};

template <class ContainerAllocator>
struct MD5Sum< ::sensor_msgs::MagneticField_<ContainerAllocator> > {
  static const char* value() { return "2f3b0b43eed0c9501de0fa3ff89a45aa"; }
