...
struct MultiDOFJointState_ {
  ...
  MultiDOFJointState_() : header(), joint_names(), transforms(), twist(), wrench() {}
  ...
  typedef std::vector<::geometry_msgs::Twist_<ContainerAllocator>,
                      typename std::allocator_traits<ContainerAllocator>::
                          template rebind_alloc<::geometry_msgs::Twist_<ContainerAllocator>>>
      _twist_type;
  _twist_type twist;

  typedef std::vector<::geometry_msgs::Wrench_<ContainerAllocator>,
                      typename std::allocator_traits<ContainerAllocator>::
                          template rebind_alloc<::geometry_msgs::Wrench_<ContainerAllocator>>>
      _wrench_type;
  _wrench_type wrench;

  typedef boost::shared_ptr<::sensor_msgs::MultiDOFJointState_<ContainerAllocator>> Ptr;
  typedef boost::shared_ptr<::sensor_msgs::MultiDOFJointState_<ContainerAllocator> const>
      ConstPtr;
...
std::ostream& operator<<(std::ostream& s,
  ...
  ros::message_operations::Printer<
      ::sensor_msgs::MultiDOFJointState_<ContainerAllocator>>::stream(s, "", v);
  return s;
}

template <typename ContainerAllocator1, typename ContainerAllocator2>
bool operator==(const ::sensor_msgs::MultiDOFJointState_<ContainerAllocator1>& lhs,
                const ::sensor_msgs::MultiDOFJointState_<ContainerAllocator2>& rhs) {
  return lhs.header == rhs.header && lhs.joint_names == rhs.joint_names &&
         lhs.transforms == rhs.transforms && lhs.twist == rhs.twist &&
...
template <class ContainerAllocator>
struct IsMessage<::sensor_msgs::MultiDOFJointState_<ContainerAllocator>> : TrueType {};

template <class ContainerAllocator>
struct IsMessage<::sensor_msgs::MultiDOFJointState_<ContainerAllocator> const> : TrueType {};

template <class ContainerAllocator>
struct IsFixedSize<::sensor_msgs::MultiDOFJointState_<ContainerAllocator>> : FalseType {};

template <class ContainerAllocator>
struct IsFixedSize<::sensor_msgs::MultiDOFJointState_<ContainerAllocator> const> : FalseType {
};

template <class ContainerAllocator>
struct HasHeader<::sensor_msgs::MultiDOFJointState_<ContainerAllocator>> : TrueType {};

template <class ContainerAllocator>
struct HasHeader<::sensor_msgs::MultiDOFJointState_<ContainerAllocator> const> : TrueType {};

template <class ContainerAllocator>
struct MD5Sum<::sensor_msgs::MultiDOFJointState_<ContainerAllocator>> {
  static const char* value() { return "690f272f0640d2631c305eeb8301e59d"; }
...
struct Definition<::sensor_msgs::MultiDOFJointState_<ContainerAllocator>> {
  static const char* value() {
    return "# Representation of state for joints with multiple degrees of freedom, \n"
           ...
           "applied \n"
           "# along the kinematic chain. For example, a planar joint (as in URDF) is 3DOF (x, "
           "y, yaw)\n"
           "# and those 3DOF can be expressed as a transformation matrix, and that "
           "transformation\n"
           "# matrix can be converted back to (x, y, yaw)\n"
           "#\n"
           "# Each joint is uniquely identified by its name\n"
           "# The header specifies the time at which the joint states were recorded. All the "
           "joint states\n"
  ...
  static void stream(Stream& s, const std::string& indent,
    ...
    for (size_t i = 0; i < v.joint_names.size(); ++i) {
      ...
      Printer<std::basic_string<char, std::char_traits<char>,
                                typename std::allocator_traits<ContainerAllocator>::
                                    template rebind_alloc<char>>>::stream(s, indent + "  ",
                                                                          v.joint_names[i]);
    }
    ...
    for (size_t i = 0; i < v.transforms.size(); ++i) {
      ...
      s << std::endl;
      s << indent;
      Printer<::geometry_msgs::Transform_<ContainerAllocator>>::stream(s, indent + "    ",
                                                                       v.transforms[i]);
    }
    ...
    for (size_t i = 0; i < v.twist.size(); ++i) {
      ...
      s << std::endl;
      s << indent;
      Printer<::geometry_msgs::Twist_<ContainerAllocator>>::stream(s, indent + "    ",
                                                                   v.twist[i]);
    }
    ...
    for (size_t i = 0; i < v.wrench.size(); ++i) {
      ...
      s << std::endl;
      s << indent;
      Printer<::geometry_msgs::Wrench_<ContainerAllocator>>::stream(s, indent + "    ",
                                                                    v.wrench[i]);
    }
  }
};
