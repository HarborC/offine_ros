...
struct MultiEchoLaserScan_ {
  ...
  typedef std::vector<::sensor_msgs::LaserEcho_<ContainerAllocator>,
                      typename std::allocator_traits<ContainerAllocator>::
                          template rebind_alloc<::sensor_msgs::LaserEcho_<ContainerAllocator>>>
      _ranges_type;
  _ranges_type ranges;
  ...
  typedef boost::shared_ptr<::sensor_msgs::MultiEchoLaserScan_<ContainerAllocator> const>
      ConstPtr;
...
std::ostream& operator<<(std::ostream& s,
  ...
  ros::message_operations::Printer<
      ::sensor_msgs::MultiEchoLaserScan_<ContainerAllocator>>::stream(s, "", v);
  return s;
}

template <typename ContainerAllocator1, typename ContainerAllocator2>
bool operator==(const ::sensor_msgs::MultiEchoLaserScan_<ContainerAllocator1>& lhs,
                const ::sensor_msgs::MultiEchoLaserScan_<ContainerAllocator2>& rhs) {
  return lhs.header == rhs.header && lhs.angle_min == rhs.angle_min &&
         lhs.angle_max == rhs.angle_max && lhs.angle_increment == rhs.angle_increment &&
         lhs.time_increment == rhs.time_increment && lhs.scan_time == rhs.scan_time &&
         lhs.range_min == rhs.range_min && lhs.range_max == rhs.range_max &&
         lhs.ranges == rhs.ranges && lhs.intensities == rhs.intensities;
}
...
template <class ContainerAllocator>
struct IsMessage<::sensor_msgs::MultiEchoLaserScan_<ContainerAllocator>> : TrueType {};

template <class ContainerAllocator>
struct IsMessage<::sensor_msgs::MultiEchoLaserScan_<ContainerAllocator> const> : TrueType {};

template <class ContainerAllocator>
struct IsFixedSize<::sensor_msgs::MultiEchoLaserScan_<ContainerAllocator>> : FalseType {};

template <class ContainerAllocator>
struct IsFixedSize<::sensor_msgs::MultiEchoLaserScan_<ContainerAllocator> const> : FalseType {
};

template <class ContainerAllocator>
struct HasHeader<::sensor_msgs::MultiEchoLaserScan_<ContainerAllocator>> : TrueType {};

template <class ContainerAllocator>
struct HasHeader<::sensor_msgs::MultiEchoLaserScan_<ContainerAllocator> const> : TrueType {};

template <class ContainerAllocator>
struct MD5Sum<::sensor_msgs::MultiEchoLaserScan_<ContainerAllocator>> {
  static const char* value() { return "6fefb0c6da89d7c8abe4b339f5c2f8fb"; }
...
struct Definition<::sensor_msgs::MultiEchoLaserScan_<ContainerAllocator>> {
  static const char* value() {
    return "# Single scan from a multi-echo planar laser range-finder\n"
           ...
           "\n"
           "LaserEcho[] ranges       # range data [m] (Note: NaNs, values < range_min or > "
           "range_max should be discarded)\n"
           "                         # +Inf measurements are out of range\n"
           "                         # -Inf measurements are too close to determine exact "
           "distance.\n"
...
struct Printer<::sensor_msgs::MultiEchoLaserScan_<ContainerAllocator>> {
  ...
  static void stream(Stream& s, const std::string& indent,
    ...
    for (size_t i = 0; i < v.ranges.size(); ++i) {
      ...
      s << std::endl;
      s << indent;
      Printer<::sensor_msgs::LaserEcho_<ContainerAllocator>>::stream(s, indent + "    ",
                                                                     v.ranges[i]);
    }
