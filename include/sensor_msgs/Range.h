...
std::ostream& operator<<(std::ostream& s, const ::sensor_msgs::Range_<ContainerAllocator>& v) {
  ros::message_operations::Printer< ::sensor_msgs::Range_<ContainerAllocator> >::stream(s, "",
                                                                                        v);
  return s;
}

template <typename ContainerAllocator1, typename ContainerAllocator2>
bool operator==(const ::sensor_msgs::Range_<ContainerAllocator1>& lhs,
                const ::sensor_msgs::Range_<ContainerAllocator2>& rhs) {
  return lhs.header == rhs.header && lhs.radiation_type == rhs.radiation_type &&
         lhs.field_of_view == rhs.field_of_view && lhs.min_range == rhs.min_range &&
         lhs.max_range == rhs.max_range && lhs.range == rhs.range;
}
...
template <class ContainerAllocator>
struct IsMessage< ::sensor_msgs::Range_<ContainerAllocator> > : TrueType {};

template <class ContainerAllocator>
struct IsMessage< ::sensor_msgs::Range_<ContainerAllocator> const> : TrueType {};

template <class ContainerAllocator>
struct IsFixedSize< ::sensor_msgs::Range_<ContainerAllocator> > : FalseType {};

template <class ContainerAllocator>
struct IsFixedSize< ::sensor_msgs::Range_<ContainerAllocator> const> : FalseType {};

template <class ContainerAllocator>
struct HasHeader< ::sensor_msgs::Range_<ContainerAllocator> > : TrueType {};

template <class ContainerAllocator>
struct HasHeader< ::sensor_msgs::Range_<ContainerAllocator> const> : TrueType {};

template <class ContainerAllocator>
struct MD5Sum< ::sensor_msgs::Range_<ContainerAllocator> > {
  static const char* value() { return "c005c34273dc426c67a020a87bc24148"; }
...
struct Definition< ::sensor_msgs::Range_<ContainerAllocator> > {
  static const char* value() {
    return "# Single range reading from an active ranger that emits energy and reports\n"
           ...
           "                        # +Inf represents no detection within the fixed "
           "distance.\n"
           "                        # (Object out of range)\n"
           "================================================================================\n"
           "MSG: std_msgs/Header\n"
