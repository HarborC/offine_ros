...
struct RelativeHumidity_ {
  ...
  RelativeHumidity_() : header(), relative_humidity(0.0), variance(0.0) {}
  RelativeHumidity_(const ContainerAllocator& _alloc)
      : header(_alloc), relative_humidity(0.0), variance(0.0) {
    (void)_alloc;
  }
  ...
  typedef boost::shared_ptr< ::sensor_msgs::RelativeHumidity_<ContainerAllocator> const>
      ConstPtr;
...
std::ostream& operator<<(std::ostream& s,
  ...
  ros::message_operations::Printer<
      ::sensor_msgs::RelativeHumidity_<ContainerAllocator> >::stream(s, "", v);
  return s;
}

template <typename ContainerAllocator1, typename ContainerAllocator2>
bool operator==(const ::sensor_msgs::RelativeHumidity_<ContainerAllocator1>& lhs,
                const ::sensor_msgs::RelativeHumidity_<ContainerAllocator2>& rhs) {
  return lhs.header == rhs.header && lhs.relative_humidity == rhs.relative_humidity &&
...
template <class ContainerAllocator>
struct IsMessage< ::sensor_msgs::RelativeHumidity_<ContainerAllocator> > : TrueType {};

template <class ContainerAllocator>
struct IsMessage< ::sensor_msgs::RelativeHumidity_<ContainerAllocator> const> : TrueType {};

template <class ContainerAllocator>
struct IsFixedSize< ::sensor_msgs::RelativeHumidity_<ContainerAllocator> > : FalseType {};

template <class ContainerAllocator>
struct IsFixedSize< ::sensor_msgs::RelativeHumidity_<ContainerAllocator> const> : FalseType {};

template <class ContainerAllocator>
struct HasHeader< ::sensor_msgs::RelativeHumidity_<ContainerAllocator> > : TrueType {};

template <class ContainerAllocator>
struct HasHeader< ::sensor_msgs::RelativeHumidity_<ContainerAllocator> const> : TrueType {};
