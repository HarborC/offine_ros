...
struct SetCameraInfoResponse_ {
  ...
  SetCameraInfoResponse_() : success(false), status_message() {}
  SetCameraInfoResponse_(const ContainerAllocator& _alloc)
      : success(false), status_message(_alloc) {
    (void)_alloc;
  }
  ...
  typedef boost::shared_ptr<::sensor_msgs::SetCameraInfoResponse_<ContainerAllocator> const>
      ConstPtr;
...
typedef boost::shared_ptr<::sensor_msgs::SetCameraInfoResponse const>
...
std::ostream& operator<<(std::ostream& s,
  ...
  ros::message_operations::Printer<
      ::sensor_msgs::SetCameraInfoResponse_<ContainerAllocator>>::stream(s, "", v);
  return s;
}

template <typename ContainerAllocator1, typename ContainerAllocator2>
bool operator==(const ::sensor_msgs::SetCameraInfoResponse_<ContainerAllocator1>& lhs,
                const ::sensor_msgs::SetCameraInfoResponse_<ContainerAllocator2>& rhs) {
  return lhs.success == rhs.success && lhs.status_message == rhs.status_message;
}
...
template <class ContainerAllocator>
struct IsMessage<::sensor_msgs::SetCameraInfoResponse_<ContainerAllocator>> : TrueType {};

template <class ContainerAllocator>
struct IsMessage<::sensor_msgs::SetCameraInfoResponse_<ContainerAllocator> const> : TrueType {
};

template <class ContainerAllocator>
struct IsFixedSize<::sensor_msgs::SetCameraInfoResponse_<ContainerAllocator>> : FalseType {};
...
template <class ContainerAllocator>
struct HasHeader<::sensor_msgs::SetCameraInfoResponse_<ContainerAllocator>> : FalseType {};

template <class ContainerAllocator>
struct HasHeader<::sensor_msgs::SetCameraInfoResponse_<ContainerAllocator> const> : FalseType {
};
