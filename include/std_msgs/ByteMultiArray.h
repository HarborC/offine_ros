...
struct ByteMultiArray_ {
  ...
  ByteMultiArray_() : layout(), data() {}
  ByteMultiArray_(const ContainerAllocator& _alloc) : layout(_alloc), data(_alloc) {
    (void)_alloc;
  }
...
std::ostream& operator<<(std::ostream& s,
  ...
  ros::message_operations::Printer<::std_msgs::ByteMultiArray_<ContainerAllocator>>::stream(
      s, "", v);
  return s;
}

template <typename ContainerAllocator1, typename ContainerAllocator2>
bool operator==(const ::std_msgs::ByteMultiArray_<ContainerAllocator1>& lhs,
                const ::std_msgs::ByteMultiArray_<ContainerAllocator2>& rhs) {
...
template <class ContainerAllocator>
struct IsMessage<::std_msgs::ByteMultiArray_<ContainerAllocator>> : TrueType {};

template <class ContainerAllocator>
struct IsMessage<::std_msgs::ByteMultiArray_<ContainerAllocator> const> : TrueType {};

template <class ContainerAllocator>
struct IsFixedSize<::std_msgs::ByteMultiArray_<ContainerAllocator>> : FalseType {};

template <class ContainerAllocator>
struct IsFixedSize<::std_msgs::ByteMultiArray_<ContainerAllocator> const> : FalseType {};

template <class ContainerAllocator>
struct HasHeader<::std_msgs::ByteMultiArray_<ContainerAllocator>> : FalseType {};

template <class ContainerAllocator>
struct HasHeader<::std_msgs::ByteMultiArray_<ContainerAllocator> const> : FalseType {};

template <class ContainerAllocator>
struct MD5Sum<::std_msgs::ByteMultiArray_<ContainerAllocator>> {
  static const char* value() { return "70ea476cbcfd65ac2f68f3cda1e891fe"; }
