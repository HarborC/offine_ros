...
struct Duration_ {
  ...
  Duration_() : data() {}
  Duration_(const ContainerAllocator& _alloc) : data() { (void)_alloc; }
...
std::ostream& operator<<(std::ostream& s, const ::std_msgs::Duration_<ContainerAllocator>& v) {
  ros::message_operations::Printer< ::std_msgs::Duration_<ContainerAllocator> >::stream(s, "",
                                                                                        v);
  return s;
}

template <typename ContainerAllocator1, typename ContainerAllocator2>
bool operator==(const ::std_msgs::Duration_<ContainerAllocator1>& lhs,
                const ::std_msgs::Duration_<ContainerAllocator2>& rhs) {
...
template <class ContainerAllocator>
struct IsMessage< ::std_msgs::Duration_<ContainerAllocator> > : TrueType {};

template <class ContainerAllocator>
struct IsMessage< ::std_msgs::Duration_<ContainerAllocator> const> : TrueType {};

template <class ContainerAllocator>
struct IsFixedSize< ::std_msgs::Duration_<ContainerAllocator> > : TrueType {};

template <class ContainerAllocator>
struct IsFixedSize< ::std_msgs::Duration_<ContainerAllocator> const> : TrueType {};

template <class ContainerAllocator>
struct HasHeader< ::std_msgs::Duration_<ContainerAllocator> > : FalseType {};

template <class ContainerAllocator>
struct HasHeader< ::std_msgs::Duration_<ContainerAllocator> const> : FalseType {};

template <class ContainerAllocator>
struct MD5Sum< ::std_msgs::Duration_<ContainerAllocator> > {
  static const char* value() { return "3e286caf4241d664e55f3ad380e2ae46"; }

  static const char* value(const ::std_msgs::Duration_<ContainerAllocator>&) {
    return value();
  }
...
struct Definition< ::std_msgs::Duration_<ContainerAllocator> > {
  static const char* value() { return "duration data\n"; }
