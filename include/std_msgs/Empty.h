...
struct Empty_ {
  ...
  Empty_() {}
  Empty_(const ContainerAllocator& _alloc) { (void)_alloc; }
...
template <class ContainerAllocator>
struct IsMessage< ::std_msgs::Empty_<ContainerAllocator> > : TrueType {};

template <class ContainerAllocator>
struct IsMessage< ::std_msgs::Empty_<ContainerAllocator> const> : TrueType {};

template <class ContainerAllocator>
struct IsFixedSize< ::std_msgs::Empty_<ContainerAllocator> > : TrueType {};

template <class ContainerAllocator>
struct IsFixedSize< ::std_msgs::Empty_<ContainerAllocator> const> : TrueType {};

template <class ContainerAllocator>
struct HasHeader< ::std_msgs::Empty_<ContainerAllocator> > : FalseType {};

template <class ContainerAllocator>
struct HasHeader< ::std_msgs::Empty_<ContainerAllocator> const> : FalseType {};
...
struct Printer< ::std_msgs::Empty_<ContainerAllocator> > {
  ...
  static void stream(Stream&, const std::string&,
                     const ::std_msgs::Empty_<ContainerAllocator>&) {}
};
