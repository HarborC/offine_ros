...
struct Float32_ {
  ...
  Float32_() : data(0.0) {}
  Float32_(const ContainerAllocator& _alloc) : data(0.0) { (void)_alloc; }
...
std::ostream& operator<<(std::ostream& s, const ::std_msgs::Float32_<ContainerAllocator>& v) {
  ros::message_operations::Printer< ::std_msgs::Float32_<ContainerAllocator> >::stream(s, "",
                                                                                       v);
  return s;
}

template <typename ContainerAllocator1, typename ContainerAllocator2>
bool operator==(const ::std_msgs::Float32_<ContainerAllocator1>& lhs,
                const ::std_msgs::Float32_<ContainerAllocator2>& rhs) {
...
template <class ContainerAllocator>
struct IsMessage< ::std_msgs::Float32_<ContainerAllocator> > : TrueType {};

template <class ContainerAllocator>
struct IsMessage< ::std_msgs::Float32_<ContainerAllocator> const> : TrueType {};

template <class ContainerAllocator>
struct IsFixedSize< ::std_msgs::Float32_<ContainerAllocator> > : TrueType {};

template <class ContainerAllocator>
struct IsFixedSize< ::std_msgs::Float32_<ContainerAllocator> const> : TrueType {};

template <class ContainerAllocator>
struct HasHeader< ::std_msgs::Float32_<ContainerAllocator> > : FalseType {};

template <class ContainerAllocator>
struct HasHeader< ::std_msgs::Float32_<ContainerAllocator> const> : FalseType {};

template <class ContainerAllocator>
struct MD5Sum< ::std_msgs::Float32_<ContainerAllocator> > {
  static const char* value() { return "73fcbf46b49191e672908e50842a83d4"; }
...
struct Definition< ::std_msgs::Float32_<ContainerAllocator> > {
  static const char* value() { return "float32 data\n"; }
