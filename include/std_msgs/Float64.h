...
struct Float64_ {
  ...
  Float64_() : data(0.0) {}
  Float64_(const ContainerAllocator& _alloc) : data(0.0) { (void)_alloc; }
...
std::ostream& operator<<(std::ostream& s, const ::std_msgs::Float64_<ContainerAllocator>& v) {
  ros::message_operations::Printer< ::std_msgs::Float64_<ContainerAllocator> >::stream(s, "",
                                                                                       v);
  return s;
}

template <typename ContainerAllocator1, typename ContainerAllocator2>
bool operator==(const ::std_msgs::Float64_<ContainerAllocator1>& lhs,
                const ::std_msgs::Float64_<ContainerAllocator2>& rhs) {
...
template <class ContainerAllocator>
struct IsMessage< ::std_msgs::Float64_<ContainerAllocator> > : TrueType {};

template <class ContainerAllocator>
struct IsMessage< ::std_msgs::Float64_<ContainerAllocator> const> : TrueType {};

template <class ContainerAllocator>
struct IsFixedSize< ::std_msgs::Float64_<ContainerAllocator> > : TrueType {};

template <class ContainerAllocator>
struct IsFixedSize< ::std_msgs::Float64_<ContainerAllocator> const> : TrueType {};

template <class ContainerAllocator>
struct HasHeader< ::std_msgs::Float64_<ContainerAllocator> > : FalseType {};

template <class ContainerAllocator>
struct HasHeader< ::std_msgs::Float64_<ContainerAllocator> const> : FalseType {};

template <class ContainerAllocator>
struct MD5Sum< ::std_msgs::Float64_<ContainerAllocator> > {
  static const char* value() { return "fdb28210bfa9d7c91146260178d9a584"; }
...
struct Definition< ::std_msgs::Float64_<ContainerAllocator> > {
  static const char* value() { return "float64 data\n"; }
