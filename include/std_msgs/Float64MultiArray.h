...
struct Float64MultiArray_ {
  ...
  Float64MultiArray_() : layout(), data() {}
  Float64MultiArray_(const ContainerAllocator& _alloc) : layout(_alloc), data(_alloc) {
    (void)_alloc;
  }
...
std::ostream& operator<<(std::ostream& s,
  ...
  ros::message_operations::Printer<::std_msgs::Float64MultiArray_<ContainerAllocator>>::stream(
      s, "", v);
  return s;
}

template <typename ContainerAllocator1, typename ContainerAllocator2>
bool operator==(const ::std_msgs::Float64MultiArray_<ContainerAllocator1>& lhs,
                const ::std_msgs::Float64MultiArray_<ContainerAllocator2>& rhs) {
...
template <class ContainerAllocator>
struct IsMessage<::std_msgs::Float64MultiArray_<ContainerAllocator>> : TrueType {};

template <class ContainerAllocator>
struct IsMessage<::std_msgs::Float64MultiArray_<ContainerAllocator> const> : TrueType {};

template <class ContainerAllocator>
struct IsFixedSize<::std_msgs::Float64MultiArray_<ContainerAllocator>> : FalseType {};

template <class ContainerAllocator>
struct IsFixedSize<::std_msgs::Float64MultiArray_<ContainerAllocator> const> : FalseType {};

template <class ContainerAllocator>
struct HasHeader<::std_msgs::Float64MultiArray_<ContainerAllocator>> : FalseType {};

template <class ContainerAllocator>
struct HasHeader<::std_msgs::Float64MultiArray_<ContainerAllocator> const> : FalseType {};

template <class ContainerAllocator>
struct MD5Sum<::std_msgs::Float64MultiArray_<ContainerAllocator>> {
  static const char* value() { return "4b7d974086d4060e7db4613a7e6c3ba4"; }

  static const char* value(const ::std_msgs::Float64MultiArray_<ContainerAllocator>&) {
    return value();
  }
