...
struct Int16MultiArray_ {
  ...
  Int16MultiArray_() : layout(), data() {}
  Int16MultiArray_(const ContainerAllocator& _alloc) : layout(_alloc), data(_alloc) {
    (void)_alloc;
  }
  ...
  typedef std::vector<int16_t, typename std::allocator_traits<
                                   ContainerAllocator>::template rebind_alloc<int16_t>>
      _data_type;
  _data_type data;
...
std::ostream& operator<<(std::ostream& s,
  ...
  ros::message_operations::Printer<::std_msgs::Int16MultiArray_<ContainerAllocator>>::stream(
      s, "", v);
  return s;
}

template <typename ContainerAllocator1, typename ContainerAllocator2>
bool operator==(const ::std_msgs::Int16MultiArray_<ContainerAllocator1>& lhs,
                const ::std_msgs::Int16MultiArray_<ContainerAllocator2>& rhs) {
...
template <class ContainerAllocator>
struct IsMessage<::std_msgs::Int16MultiArray_<ContainerAllocator>> : TrueType {};

template <class ContainerAllocator>
struct IsMessage<::std_msgs::Int16MultiArray_<ContainerAllocator> const> : TrueType {};

template <class ContainerAllocator>
struct IsFixedSize<::std_msgs::Int16MultiArray_<ContainerAllocator>> : FalseType {};

template <class ContainerAllocator>
struct IsFixedSize<::std_msgs::Int16MultiArray_<ContainerAllocator> const> : FalseType {};

template <class ContainerAllocator>
struct HasHeader<::std_msgs::Int16MultiArray_<ContainerAllocator>> : FalseType {};

template <class ContainerAllocator>
struct HasHeader<::std_msgs::Int16MultiArray_<ContainerAllocator> const> : FalseType {};

template <class ContainerAllocator>
struct MD5Sum<::std_msgs::Int16MultiArray_<ContainerAllocator>> {
  static const char* value() { return "d9338d7f523fcb692fae9d0a0e9f067c"; }

  static const char* value(const ::std_msgs::Int16MultiArray_<ContainerAllocator>&) {
    return value();
  }
