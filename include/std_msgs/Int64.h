...
struct Int64_ {
  ...
  Int64_() : data(0) {}
  Int64_(const ContainerAllocator& _alloc) : data(0) { (void)_alloc; }
...
bool operator==(const ::std_msgs::Int64_<ContainerAllocator1>& lhs,
                const ::std_msgs::Int64_<ContainerAllocator2>& rhs) {
...
template <class ContainerAllocator>
struct IsMessage< ::std_msgs::Int64_<ContainerAllocator> > : TrueType {};

template <class ContainerAllocator>
struct IsMessage< ::std_msgs::Int64_<ContainerAllocator> const> : TrueType {};

template <class ContainerAllocator>
struct IsFixedSize< ::std_msgs::Int64_<ContainerAllocator> > : TrueType {};

template <class ContainerAllocator>
struct IsFixedSize< ::std_msgs::Int64_<ContainerAllocator> const> : TrueType {};

template <class ContainerAllocator>
struct HasHeader< ::std_msgs::Int64_<ContainerAllocator> > : FalseType {};

template <class ContainerAllocator>
struct HasHeader< ::std_msgs::Int64_<ContainerAllocator> const> : FalseType {};

template <class ContainerAllocator>
struct MD5Sum< ::std_msgs::Int64_<ContainerAllocator> > {
  static const char* value() { return "34add168574510e6e17f5d23ecc077ef"; }
...
struct Definition< ::std_msgs::Int64_<ContainerAllocator> > {
  static const char* value() { return "int64 data\n"; }
