...
struct Int8_ {
  ...
  Int8_() : data(0) {}
  Int8_(const ContainerAllocator& _alloc) : data(0) { (void)_alloc; }
...
bool operator==(const ::std_msgs::Int8_<ContainerAllocator1>& lhs,
                const ::std_msgs::Int8_<ContainerAllocator2>& rhs) {
...
template <class ContainerAllocator>
struct IsMessage< ::std_msgs::Int8_<ContainerAllocator> > : TrueType {};

template <class ContainerAllocator>
struct IsMessage< ::std_msgs::Int8_<ContainerAllocator> const> : TrueType {};

template <class ContainerAllocator>
struct IsFixedSize< ::std_msgs::Int8_<ContainerAllocator> > : TrueType {};

template <class ContainerAllocator>
struct IsFixedSize< ::std_msgs::Int8_<ContainerAllocator> const> : TrueType {};

template <class ContainerAllocator>
struct HasHeader< ::std_msgs::Int8_<ContainerAllocator> > : FalseType {};

template <class ContainerAllocator>
struct HasHeader< ::std_msgs::Int8_<ContainerAllocator> const> : FalseType {};

template <class ContainerAllocator>
struct MD5Sum< ::std_msgs::Int8_<ContainerAllocator> > {
  static const char* value() { return "27ffa0c9c4b8fb8492252bcad9e5c57b"; }
...
struct Definition< ::std_msgs::Int8_<ContainerAllocator> > {
  static const char* value() { return "int8 data\n"; }
