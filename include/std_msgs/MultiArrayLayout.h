...
struct MultiArrayLayout_ {
  ...
  MultiArrayLayout_() : dim(), data_offset(0) {}
  MultiArrayLayout_(const ContainerAllocator& _alloc) : dim(_alloc), data_offset(0) {
    (void)_alloc;
  }
...
std::ostream& operator<<(std::ostream& s,
  ...
  ros::message_operations::Printer<::std_msgs::MultiArrayLayout_<ContainerAllocator>>::stream(
      s, "", v);
  return s;
}

template <typename ContainerAllocator1, typename ContainerAllocator2>
bool operator==(const ::std_msgs::MultiArrayLayout_<ContainerAllocator1>& lhs,
                const ::std_msgs::MultiArrayLayout_<ContainerAllocator2>& rhs) {
  return lhs.dim == rhs.dim && lhs.data_offset == rhs.data_offset;
}
...
template <class ContainerAllocator>
struct IsMessage<::std_msgs::MultiArrayLayout_<ContainerAllocator>> : TrueType {};

template <class ContainerAllocator>
struct IsMessage<::std_msgs::MultiArrayLayout_<ContainerAllocator> const> : TrueType {};

template <class ContainerAllocator>
struct IsFixedSize<::std_msgs::MultiArrayLayout_<ContainerAllocator>> : FalseType {};

template <class ContainerAllocator>
struct IsFixedSize<::std_msgs::MultiArrayLayout_<ContainerAllocator> const> : FalseType {};

template <class ContainerAllocator>
struct HasHeader<::std_msgs::MultiArrayLayout_<ContainerAllocator>> : FalseType {};

template <class ContainerAllocator>
struct HasHeader<::std_msgs::MultiArrayLayout_<ContainerAllocator> const> : FalseType {};

template <class ContainerAllocator>
struct MD5Sum<::std_msgs::MultiArrayLayout_<ContainerAllocator>> {
  static const char* value() { return "0fed2a11c13e11c5571b4e2a995a91a3"; }
...
struct Printer<::std_msgs::MultiArrayLayout_<ContainerAllocator>> {
  ...
  static void stream(Stream& s, const std::string& indent,
    ...
    for (size_t i = 0; i < v.dim.size(); ++i) {
      ...
      s << std::endl;
      s << indent;
      Printer<::std_msgs::MultiArrayDimension_<ContainerAllocator>>::stream(s, indent + "    ",
                                                                            v.dim[i]);
    }
