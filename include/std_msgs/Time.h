...
struct Time_ {
  ...
  Time_() : data() {}
  Time_(const ContainerAllocator& _alloc) : data() { (void)_alloc; }
...
bool operator==(const ::std_msgs::Time_<ContainerAllocator1>& lhs,
                const ::std_msgs::Time_<ContainerAllocator2>& rhs) {
...
template <class ContainerAllocator>
struct IsMessage< ::std_msgs::Time_<ContainerAllocator> > : TrueType {};

template <class ContainerAllocator>
struct IsMessage< ::std_msgs::Time_<ContainerAllocator> const> : TrueType {};

template <class ContainerAllocator>
struct IsFixedSize< ::std_msgs::Time_<ContainerAllocator> > : TrueType {};

template <class ContainerAllocator>
struct IsFixedSize< ::std_msgs::Time_<ContainerAllocator> const> : TrueType {};

template <class ContainerAllocator>
struct HasHeader< ::std_msgs::Time_<ContainerAllocator> > : FalseType {};

template <class ContainerAllocator>
struct HasHeader< ::std_msgs::Time_<ContainerAllocator> const> : FalseType {};

template <class ContainerAllocator>
struct MD5Sum< ::std_msgs::Time_<ContainerAllocator> > {
  static const char* value() { return "cd7166c74c552c311fbcc2fe5a7bc289"; }
...
struct Definition< ::std_msgs::Time_<ContainerAllocator> > {
  static const char* value() { return "time data\n"; }
