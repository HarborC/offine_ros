...
struct UInt32_ {
  ...
  UInt32_() : data(0) {}
  UInt32_(const ContainerAllocator& _alloc) : data(0) { (void)_alloc; }
...
std::ostream& operator<<(std::ostream& s, const ::std_msgs::UInt32_<ContainerAllocator>& v) {
  ros::message_operations::Printer< ::std_msgs::UInt32_<ContainerAllocator> >::stream(s, "",
                                                                                      v);
  return s;
}

template <typename ContainerAllocator1, typename ContainerAllocator2>
bool operator==(const ::std_msgs::UInt32_<ContainerAllocator1>& lhs,
                const ::std_msgs::UInt32_<ContainerAllocator2>& rhs) {
...
template <class ContainerAllocator>
struct IsMessage< ::std_msgs::UInt32_<ContainerAllocator> > : TrueType {};

template <class ContainerAllocator>
struct IsMessage< ::std_msgs::UInt32_<ContainerAllocator> const> : TrueType {};

template <class ContainerAllocator>
struct IsFixedSize< ::std_msgs::UInt32_<ContainerAllocator> > : TrueType {};

template <class ContainerAllocator>
struct IsFixedSize< ::std_msgs::UInt32_<ContainerAllocator> const> : TrueType {};

template <class ContainerAllocator>
struct HasHeader< ::std_msgs::UInt32_<ContainerAllocator> > : FalseType {};

template <class ContainerAllocator>
struct HasHeader< ::std_msgs::UInt32_<ContainerAllocator> const> : FalseType {};

template <class ContainerAllocator>
struct MD5Sum< ::std_msgs::UInt32_<ContainerAllocator> > {
  static const char* value() { return "304a39449588c7f8ce2df6e8001c5fce"; }
...
struct Definition< ::std_msgs::UInt32_<ContainerAllocator> > {
  static const char* value() { return "uint32 data\n"; }
