...
struct UInt32MultiArray_ {
  ...
  UInt32MultiArray_() : layout(), data() {}
  UInt32MultiArray_(const ContainerAllocator& _alloc) : layout(_alloc), data(_alloc) {
    (void)_alloc;
  }
  ...
  typedef std::vector<uint32_t, typename std::allocator_traits<
                                    ContainerAllocator>::template rebind_alloc<uint32_t>>
      _data_type;
  _data_type data;
...
std::ostream& operator<<(std::ostream& s,
  ...
  ros::message_operations::Printer<::std_msgs::UInt32MultiArray_<ContainerAllocator>>::stream(
      s, "", v);
  return s;
}

template <typename ContainerAllocator1, typename ContainerAllocator2>
bool operator==(const ::std_msgs::UInt32MultiArray_<ContainerAllocator1>& lhs,
                const ::std_msgs::UInt32MultiArray_<ContainerAllocator2>& rhs) {
...
template <class ContainerAllocator>
struct IsMessage<::std_msgs::UInt32MultiArray_<ContainerAllocator>> : TrueType {};

template <class ContainerAllocator>
struct IsMessage<::std_msgs::UInt32MultiArray_<ContainerAllocator> const> : TrueType {};

template <class ContainerAllocator>
struct IsFixedSize<::std_msgs::UInt32MultiArray_<ContainerAllocator>> : FalseType {};

template <class ContainerAllocator>
struct IsFixedSize<::std_msgs::UInt32MultiArray_<ContainerAllocator> const> : FalseType {};

template <class ContainerAllocator>
struct HasHeader<::std_msgs::UInt32MultiArray_<ContainerAllocator>> : FalseType {};

template <class ContainerAllocator>
struct HasHeader<::std_msgs::UInt32MultiArray_<ContainerAllocator> const> : FalseType {};

template <class ContainerAllocator>
struct MD5Sum<::std_msgs::UInt32MultiArray_<ContainerAllocator>> {
  static const char* value() { return "4d6a180abc9be191b96a7eda6c8a233d"; }
