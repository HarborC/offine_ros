...
struct UInt8_ {
  ...
  UInt8_() : data(0) {}
  UInt8_(const ContainerAllocator& _alloc) : data(0) { (void)_alloc; }
...
bool operator==(const ::std_msgs::UInt8_<ContainerAllocator1>& lhs,
                const ::std_msgs::UInt8_<ContainerAllocator2>& rhs) {
...
template <class ContainerAllocator>
struct IsMessage< ::std_msgs::UInt8_<ContainerAllocator> > : TrueType {};

template <class ContainerAllocator>
struct IsMessage< ::std_msgs::UInt8_<ContainerAllocator> const> : TrueType {};

template <class ContainerAllocator>
struct IsFixedSize< ::std_msgs::UInt8_<ContainerAllocator> > : TrueType {};

template <class ContainerAllocator>
struct IsFixedSize< ::std_msgs::UInt8_<ContainerAllocator> const> : TrueType {};

template <class ContainerAllocator>
struct HasHeader< ::std_msgs::UInt8_<ContainerAllocator> > : FalseType {};

template <class ContainerAllocator>
struct HasHeader< ::std_msgs::UInt8_<ContainerAllocator> const> : FalseType {};

template <class ContainerAllocator>
struct MD5Sum< ::std_msgs::UInt8_<ContainerAllocator> > {
  static const char* value() { return "7c8164229e7d2c17eb95e9231617fdee"; }
