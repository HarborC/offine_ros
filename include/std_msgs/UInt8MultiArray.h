...
struct UInt8MultiArray_ {
  ...
  UInt8MultiArray_() : layout(), data() {}
  UInt8MultiArray_(const ContainerAllocator& _alloc) : layout(_alloc), data(_alloc) {
    (void)_alloc;
  }
...
std::ostream& operator<<(std::ostream& s,
  ...
  ros::message_operations::Printer<::std_msgs::UInt8MultiArray_<ContainerAllocator>>::stream(
      s, "", v);
  return s;
}

template <typename ContainerAllocator1, typename ContainerAllocator2>
bool operator==(const ::std_msgs::UInt8MultiArray_<ContainerAllocator1>& lhs,
                const ::std_msgs::UInt8MultiArray_<ContainerAllocator2>& rhs) {
...
template <class ContainerAllocator>
struct IsMessage<::std_msgs::UInt8MultiArray_<ContainerAllocator>> : TrueType {};

template <class ContainerAllocator>
struct IsMessage<::std_msgs::UInt8MultiArray_<ContainerAllocator> const> : TrueType {};

template <class ContainerAllocator>
struct IsFixedSize<::std_msgs::UInt8MultiArray_<ContainerAllocator>> : FalseType {};

template <class ContainerAllocator>
struct IsFixedSize<::std_msgs::UInt8MultiArray_<ContainerAllocator> const> : FalseType {};

template <class ContainerAllocator>
struct HasHeader<::std_msgs::UInt8MultiArray_<ContainerAllocator>> : FalseType {};

template <class ContainerAllocator>
struct HasHeader<::std_msgs::UInt8MultiArray_<ContainerAllocator> const> : FalseType {};

template <class ContainerAllocator>
struct MD5Sum<::std_msgs::UInt8MultiArray_<ContainerAllocator>> {
  static const char* value() { return "82373f1612381bb6ee473b5cd6f5d89c"; }

  static const char* value(const ::std_msgs::UInt8MultiArray_<ContainerAllocator>&) {
    return value();
  }
